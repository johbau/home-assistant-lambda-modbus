...
DATA_SCHEMA = vol.Schema(
    {
        ...
        vol.Optional(CONF_HEAT_PUMP1, default=DEFAULT_HEAT_PUMP1): bool,
        vol.Optional(CONF_HEAT_PUMP2, default=DEFAULT_HEAT_PUMP2): bool,
        vol.Optional(CONF_HEAT_PUMP3, default=DEFAULT_HEAT_PUMP3): bool,
