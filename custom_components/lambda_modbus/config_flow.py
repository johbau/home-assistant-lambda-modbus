...
from .const import (
    ...
    DEFAULT_HEAT_CIRCUIT5,
    DEFAULT_HEAT_CIRCUIT6,
    DEFAULT_HEAT_CIRCUIT7,
    DEFAULT_HEAT_CIRCUIT8,
    DEFAULT_HEAT_CIRCUIT9,
    DEFAULT_HEAT_CIRCUIT10,
    DEFAULT_HEAT_CIRCUIT11,
    DEFAULT_HEAT_CIRCUIT12,
)
...
DATA_SCHEMA = vol.Schema(
    {
        ...
        vol.Optional(CONF_HEAT_CIRCUIT5, default=DEFAULT_HEAT_CIRCUIT5): bool,
        vol.Optional(CONF_HEAT_CIRCUIT6, default=DEFAULT_HEAT_CIRCUIT6): bool,
        vol.Optional(CONF_HEAT_CIRCUIT7, default=DEFAULT_HEAT_CIRCUIT7): bool,
        vol.Optional(CONF_HEAT_CIRCUIT8, default=DEFAULT_HEAT_CIRCUIT8): bool,
        vol.Optional(CONF_HEAT_CIRCUIT9, default=DEFAULT_HEAT_CIRCUIT9): bool,
        vol.Optional(CONF_HEAT_CIRCUIT10, default=DEFAULT_HEAT_CIRCUIT10): bool,
        vol.Optional(CONF_HEAT_CIRCUIT11, default=DEFAULT_HEAT_CIRCUIT11): bool,
        vol.Optional(CONF_HEAT_CIRCUIT12, default=DEFAULT_HEAT_CIRCUIT12): bool,
